...
# ─────────────────────────────────────────────
TOPICS = [
    "/astrid/slam/trajectory",
    "/astrid/navigation/global_path",
    "/astrid/navigation/local_path/obstacle_maneuver",
    "/astrid/navigation/local_path/station_maneuvers",
    "/astrid/navigation/local_path/park_maneuver",
        ...
        for topic in pending:
            ...
            try:
                ...
                self.get_logger().debug(
                    f"[TopicWatchdog] Abone olundu: {topic} [{Path}]"
                )
