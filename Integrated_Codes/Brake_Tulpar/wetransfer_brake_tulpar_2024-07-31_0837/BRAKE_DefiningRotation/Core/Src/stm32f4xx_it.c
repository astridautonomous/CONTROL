...
volatile uint16_t falling_detected=1; //proximity1
volatile uint32_t signal=0;
volatile uint32_t command=0;
volatile uint32_t falling_detected2=1;//proximity2
//tulpa
...
void EXTI3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(PROX_BACK_Pin);
